          ...
          <div className="row justify-content-center">
            <div className="col-md-6 col-lg-4 mb-5">
              ...
              >
                ...
                <img
                  className="img-fluid"
                  src="{{ basePath }}/assets/img/portfolio/cabin.png"
                  alt="..."
                />
              </div>
            </div>
            <div className="col-md-6 col-lg-4 mb-5">
              ...
              >
                ...
                <img
                  className="img-fluid"
                  src="{{ basePath }}/assets/img/portfolio/cake.png"
                  alt="..."
                />
              </div>
            </div>
            <div className="col-md-6 col-lg-4 mb-5">
              ...
              >
                ...
                <img
                  className="img-fluid"
                  src="{{ basePath }}/assets/img/portfolio/circus.png"
                  alt="..."
                />
              </div>
            </div>
            <div className="col-md-6 col-lg-4 mb-5 mb-lg-0">
              ...
              >
                ...
                <img
                  className="img-fluid"
                  src="{{ basePath }}/assets/img/portfolio/game.png"
                  alt="..."
                />
              </div>
            </div>
            <div className="col-md-6 col-lg-4 mb-5 mb-md-0">
              ...
              >
                ...
                <img
                  className="img-fluid"
                  src="{{ basePath }}/assets/img/portfolio/safe.png"
                  alt="..."
                />
              </div>
            </div>
            <div className="col-md-6 col-lg-4">
              ...
              >
                ...
                <img
                  className="img-fluid"
                  src="{{ basePath }}/assets/img/portfolio/submarine.png"
                  alt="..."
                />
              </div>
            </div>
